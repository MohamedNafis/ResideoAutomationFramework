...
import static utils.InterFaceConstant.*;
...
public class BaseClass {
	...
	private void initDriver() {
		...
		case CHROME:
			...
			break;
		case FIREFOX:
			System.getProperty("WebDriver.geckodriver.driver", "./driver/geckodriver");
			driver = new FirefoxDriver();
			break;
		case EDGE:
			System.getProperty("WebDriver.msedgedriver.driver", "./driver/msedgedriver");
			driver = new EdgeDriver();
			break;	
		default:
			WebDriverManager.chromedriver().setup();
